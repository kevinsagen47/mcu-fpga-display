...
uint8_t display_page_setting_1_dist_energy[60] = {0x63,0X62,0X4D,0X6F,0X64,0X65,0X53,0X65,0X6C,0X65,0X63,0X74,0x2E,0x76,0x61,0x6C,0x3D,0x34,0xff,0xff,0xff//set drop down to energy
																										,0x74,0x4D,0x6F,0x64,0x65,0x2E,0x74,0x78,0x74,0x3D,0x22,0xAF,0xE0,0xB6,0x71,0x22,0xff,0xff,0xff//print jiaoer change to neng liang AF E0 B6 71
...
//62,0x46,0x72,0x65,0x71,0x53,0x77,0x65,0x65,0x70
//62 50 72 65 56 69 62 2E 74 78 74 3D 22 B1 BD C0 57 A4 A4 22 ff ff ff sao ping zhong
uint8_t display_page_head_diagnosis_on[24]={0x62,0x46,0x72,0x65,0x71,0x53,0x77,0x65,0x65,0x70,0x2E,0x74,0x78,0x74,0x3D,0x22,0xB6,0x7D,0xB1,0xD2,0x22,0xff,0xff,0xff};//bPreVib.txt="kai qi"
uint8_t display_page_head_diagnosis_off[26]={0x62,0x46,0x72,0x65,0x71,0x53,0x77,0x65,0x65,0x70,0x2E,0x74,0x78,0x74,0x3D,0x22,0xB1,0xBD,0xC0,0x57,0xA4,0xA4,0x22,0xff,0xff,0xff};//bPreVib.txt="sao ping zhong"
...
void print_page_head_diagnosis(){
	if(read_head_sweep_display()==1)UART_Write(UART1,display_page_head_diagnosis_off,26);
	else UART_Write(UART1,display_page_head_diagnosis_on,24);
