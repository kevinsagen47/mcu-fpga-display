...
//62 50 72 65 56 69 62 2E 74 78 74 3D 22 B1 BD A5 AD A4 A4 22 ff ff ff sao ping zhong
...
uint8_t display_page_head_diagnosis_off[23]={0x62,0x50,0x72,0x65,0x56,0x69,0x62,0x2E,0x74,0x78,0x74,0x3D,0x22,0xB1,0xBD,0xA5,0xAD,0xA4,0xA4,0x22,0xff,0xff,0xff};//bPreVib.txt="sao ping zhong"
...
void print_page_head_diagnosis(){
	if(read_head_sweep_display()==1)UART_Write(UART1,display_page_head_diagnosis_off,23);
