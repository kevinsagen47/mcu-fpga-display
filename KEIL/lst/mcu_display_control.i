...
uint8_t display_page_setting_1_dist_energy[60] = {0x63,0X62,0X4D,0X6F,0X64,0X65,0X53,0X65,0X6C,0X65,0X63,0X74,0x2E,0x76,0x61,0x6C,0x3D,0x34,0xff,0xff,0xff
																										,0x74,0x4D,0x6F,0x64,0x65,0x2E,0x74,0x78,0x74,0x3D,0x22,0xB5,0x4A,0xA6,0xD5,0x22,0xff,0xff,0xff
...
uint8_t display_page_head_diagnosis_off[23]={0x62,0x50,0x72,0x65,0x56,0x69,0x62,0x2E,0x74,0x78,0x74,0x3D,0x22,0xB1,0xBD,0xA5,0xAD,0xA4,0xA4,0x22,0xff,0xff,0xff};
...
void print_page_head_diagnosis(){
	if(read_head_sweep_display()==1)UART_Write(((UART_T *) ((((uint32_t)0x40000000) + (uint32_t)0x00040000) + 0x31000UL)),display_page_head_diagnosis_off,23);
