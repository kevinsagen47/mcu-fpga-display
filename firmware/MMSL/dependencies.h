...
unsigned int read_freq_start_html(unsigned int arg);
unsigned int read_freq_end_html(unsigned int arg);
unsigned int read_freq_max_html(unsigned int arg);
unsigned int read_freq_min_html(unsigned int arg);
unsigned int read_P_max_html(unsigned int arg);
unsigned int read_avg_power_html(unsigned int arg);
unsigned int read_energy_display_html(unsigned int arg);
unsigned int read_time_on_html(unsigned int arg);

unsigned int read_F_set_history_html(unsigned int arg);
unsigned int read_F_start_html(unsigned int arg);
unsigned int read_F_max_html(unsigned int arg);
unsigned int read_encoder_speed_history_html(unsigned int arg);
unsigned int read_distance_reached_html(unsigned int arg);
unsigned int read_absolute_hold_html(unsigned int arg);
unsigned int read_distance_travelled_html(unsigned int arg);
unsigned int read_collapse_hold_html(unsigned int arg);
unsigned int read_total_time_display_html(unsigned int arg);
///////////////////////////////////////////////////////////////////////
